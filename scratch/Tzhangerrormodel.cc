...
//  allBwps = CcBwpCreator::GetAllBwps ({band1, band2});//znr_note: allBwps长度等于2
  ...
  nrHelper->GetGnbPhy (gnbNetDev.Get (0), 1)->SetAttribute ("Numerology", UintegerValue (numerologyBwp));
  nrHelper->GetGnbPhy (gnbNetDev.Get (0), 1)->SetAttribute ("TxPower", DoubleValue (totalTxPower));
